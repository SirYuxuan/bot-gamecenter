 ...
 */
package com.yuxuan66.botgamecenter.gobang;

import cn.hutool.core.convert.Convert;
import cn.hutool.core.util.RandomUtil;
import com.alibaba.fastjson.JSONObject;
import com.yuxuan66.botgamecenter.base.Result;
import com.yuxuan66.botgamecenter.utils.ResponseUtil;
...
public class GoBang {
    ...
    static {
        try {
            sunspot = ImageIO.read(new File("C:\\Users\\Administrator\\Desktop\\hei.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    static {
        try {
            whiteSeed = ImageIO.read(new File("C:\\Users\\Administrator\\Desktop\\bai.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void showCheckerboard(HttpServletResponse response) throws IOException {
        ResponseUtil.outImg(response,ImageIO.read(new File("C:\\Users\\Administrator\\Desktop\\bg.png")));
    }
}
