...
import com.yuxuan66.botgamecenter.base.BaseGameRoom;
...
public class GoBangRoom extends BaseGameRoom {
    ...
    {
        try {
            bufferedImage = ImageIO.read(new File("C:\\Users\\Administrator\\Desktop\\bg.png"));
    ...
    public Result fallenSon(String fromQQ, String position) {
        ...
        mergeCell.setX(14 + (y - 1) * 35);
        mergeCell.setY(14 + (15 - x) * 35);
